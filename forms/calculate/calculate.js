...
//create the 3 paramters for the user to unter 
let userNum1 = Number(prompt("please enter the first number"))
let userNum2 = Number(prompt("please enter the second number"))
